...
const { sendOTPEmail, sendPasswordChangedNotification } = require('../config/emailConfig.js');
...
module.exports = { getAllUser, userCountByRole, userByRole, createNewUser, deleteUser, getUserInfoById, updateUser, handleLogin, sendPasswordResetOTP, verifyOTP, changePassword, resetPassword, changePasswordWithOldPassword,verifyOldPasswordOnly  };